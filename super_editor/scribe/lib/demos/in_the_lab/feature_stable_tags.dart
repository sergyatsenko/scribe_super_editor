...
class _UserSelectionPopoverState extends State<UserSelectionPopover> {
  ...
  void initState() {
    ...
    widget.userTagPlugin.tagIndex.composingStableTag
  ...
  void didUpdateWidget(UserSelectionPopover oldWidget) {
    ...
    if (widget.userTagPlugin != oldWidget.userTagPlugin) {
      oldWidget.userTagPlugin.tagIndex.composingStableTag
  ...
  Future<void> _onComposingTokenChange() async {
    final composingTag =
        widget.userTagPlugin.tagIndex.composingStableTag.value?.token;
  ...
  void _selectMatchingUsers(String composingTag) {
    _matchingUsers
      ..clear()
      ..addAll(_userCandidates.where(
          (user) => user.toLowerCase().contains(composingTag.toLowerCase())));
  }
