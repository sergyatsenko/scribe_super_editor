...
class NativeIosContextMenuFeatureDemo extends StatefulWidget {
  ...
  @override
  State<NativeIosContextMenuFeatureDemo> createState() =>
      _NativeIosContextMenuFeatureDemoState();
}

class _NativeIosContextMenuFeatureDemoState
    extends State<NativeIosContextMenuFeatureDemo> {
...
class _SuperTextFieldWithNativeContextMenu extends StatefulWidget {
  ...
  @override
  State<_SuperTextFieldWithNativeContextMenu> createState() =>
      _SuperTextFieldWithNativeContextMenuState();
}

class _SuperTextFieldWithNativeContextMenuState
