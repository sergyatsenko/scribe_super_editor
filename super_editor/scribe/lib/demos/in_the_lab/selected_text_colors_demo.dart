...
class _SelectedTextColorsDemoState extends State<SelectedTextColorsDemo> {
  ...
  Color _selectedTextColorStrategy(
  ...
  Widget _buildControlPanel() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _buildColorSelector(
              _regularTextColor, "REGULAR TEXT", _regularTextColorLeaderLink),
          const SizedBox(height: 24),
          _buildColorSelector(_selectionHighlightColor, "SELECTION HIGHLIGHT",
              _selectionHighlightColorLeaderLink),
          const SizedBox(height: 24),
          _buildColorSelector(_selectedTextColor, "SELECTED TEXT",
              _selectedTextColorLeaderLink),
        ],
      ),
    );
  }
  ...
  Widget _buildOverlay() {
    ...
    return ColorPickerPopoverModal(
      ...
      onColorSelected: (color) {
        ...
        } else if (_activeColorSelectorLink ==
            _selectionHighlightColorLeaderLink) {
          setState(() {
  ...
  Widget _buildColorSelector(Color currentColor, String label,
