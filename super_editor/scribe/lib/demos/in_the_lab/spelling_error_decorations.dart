...
class SpellingErrorDecorationsDemo extends StatefulWidget {
  ...
  @override
  State<SpellingErrorDecorationsDemo> createState() =>
      _SpellingErrorDecorationsDemoState();
}

class _SpellingErrorDecorationsDemoState
    extends State<SpellingErrorDecorationsDemo> {
      ...
      ParagraphNode(
        ...
        text: AttributedText(
          ...
          AttributedSpans(
            attributions: [
              SpanMarker(
                  attribution: spellingErrorAttribution,
                  offset: 12,
        ...
        addRulesAfter: [
          ...
          if (_decoration == null)
            StyleRule(
              ...
              (doc, docNode) {
                return {
                  Styles.spellingErrorUnderlineStyle:
...
class SpellingErrorParagraphComponentBuilder implements ComponentBuilder {
  ...
  SingleColumnLayoutComponentViewModel? createViewModel(
    ...
    final viewModel = ParagraphComponentBuilder()
    ...
    return viewModel
      ...
      ..spellingErrors = (node as TextNode)
          ...
          .map((a) => TextRange(
              start: a.start,
              end: a.end + 1)) // +1 because text range end is exclusive
          .toList();
  }
  ...
  Widget? createComponent(
    ...
    return ParagraphComponentBuilder()
        .createComponent(componentContext, componentViewModel);
  }
}
