import 'package:scribe/demos/supertextfield/_emojis_demo.dart';
import 'package:scribe/demos/supertextfield/_expanding_multi_line_demo.dart';
import 'package:scribe/demos/supertextfield/_interactive_demo.dart';
import 'package:scribe/demos/supertextfield/textfield_inside_single_child_scroll_view_demo.dart';
import 'package:scribe/demos/supertextfield/textfield_inside_slivers_demo.dart';
import 'package:scribe/demos/supertextfield/_single_line_demo.dart';
import 'package:scribe/demos/supertextfield/_static_multi_line_demo.dart';
import 'package:scribe/demos/supertextfield/_textfield_demo_screen.dart';
      ...
      menuItems: [
        ...
        DemoMenuItem(
          ...
          onPressed: () {
            setState(() {
              _demoBuilder =
                  (_) => const TextFieldInsideSingleChildScrollViewDemo();
            });
          },
        ),
      ],
