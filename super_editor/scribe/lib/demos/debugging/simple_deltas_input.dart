...
class _SimpleDeltasInputState extends State<SimpleDeltasInputDemo>
  ...
  void _onTapOnText(TapUpDetails details) {
    ...
    final textTapPosition =
        textLayout.getPositionNearestToOffset(textTapOffset);
        ...
        child: DecoratedBox(
          ...
          child: SuperTextWithSelection.single(
            ...
            userSelection: UserSelection(
              selection: _currentTextEditingValue?.selection ??
