import 'package:scribe/demos/mobile_chat/giphy_keyboard_panel.dart';
...
class _MobileChatDemoState extends State<MobileChatDemo> {
  ...
  void initState() {
    ...
    _keyboardPanelController =
        KeyboardPanelController(_softwareKeyboardController);
                ...
                slivers: [
                  SliverPadding(
                    padding: EdgeInsets.only(
                      bottom: KeyboardScaffoldSafeAreaScope.of(context)
                          .geometry
                          .bottomPadding,
...
class _TapToFocusEditor extends ContentTapDelegate {
  ...
  TapHandlingInstruction onTap(DocumentTapDetails details) {
    if (!keyboardPanelController.isSoftwareKeyboardOpen &&
        !keyboardPanelController.isKeyboardPanelOpen) {
...
class _BottomSheetWithoutButtonOptions extends StatefulWidget {
  ...
  @override
  State<_BottomSheetWithoutButtonOptions> createState() =>
      _BottomSheetWithoutButtonOptionsState();
}

class _BottomSheetWithoutButtonOptionsState
    extends State<_BottomSheetWithoutButtonOptions> {
  @override
  Widget build(BuildContext context) {
    return Padding(
