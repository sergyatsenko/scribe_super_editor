...
import 'package:scribe/demos/editor_configs/keyboard_overlay_clipper.dart';
...
class _MobileEditingIOSDemoState extends State<MobileEditingIOSDemo>
  ...
  Widget _buildIosToolbar(
      BuildContext context, Key mobileToolbarKey, LeaderLink focalPoint) {
  ...
  Widget _buildIosMagnifier(BuildContext context, Key magnifierKey,
